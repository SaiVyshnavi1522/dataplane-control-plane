...
const (
	ClusterService_CreateCluster_FullMethodName = "/dataplane.v1.ClusterService/CreateCluster"
	ClusterService_GetCluster_FullMethodName    = "/dataplane.v1.ClusterService/GetCluster"
	ClusterService_ListClusters_FullMethodName  = "/dataplane.v1.ClusterService/ListClusters"
	ClusterService_ScaleCluster_FullMethodName  = "/dataplane.v1.ClusterService/ScaleCluster"
	ClusterService_DeleteCluster_FullMethodName = "/dataplane.v1.ClusterService/DeleteCluster"
)
...
type ClusterServiceClient interface {
	...
	ScaleCluster(ctx context.Context, in *ScaleClusterRequest, opts ...grpc.CallOption) (*Cluster, error)
...
func (c *clusterServiceClient) ScaleCluster(ctx context.Context, in *ScaleClusterRequest, opts ...grpc.CallOption) (*Cluster, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Cluster)
...
func (c *clusterServiceClient) DeleteCluster(ctx context.Context, in *DeleteClusterRequest, opts ...grpc.CallOption) (*Cluster, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Cluster)
...
type ClusterServiceServer interface {
	...
	ScaleCluster(context.Context, *ScaleClusterRequest) (*Cluster, error)
...
func (UnimplementedClusterServiceServer) ScaleCluster(context.Context, *ScaleClusterRequest) (*Cluster, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ScaleCluster not implemented")
}
func (UnimplementedClusterServiceServer) DeleteCluster(context.Context, *DeleteClusterRequest) (*Cluster, error) {
...
var ClusterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dataplane.v1.ClusterService",
	...
	Metadata: "dataplane/v1/clusters.proto",
}
